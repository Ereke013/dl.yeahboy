            ...
            <div class="col-sm-6 mt-4 offset-1">
                <form action="save.php" method="post">
                    ...
                    <div class="form-group">
                        <label>Name:</label>
                        <input class="form-control" name="name" type="text" value="<?php echo $teacher['name'] ?>">
                    </div>
                    <div class="form-group">
                        <label>Surname:</label>
                        <input class="form-control" name="surname" type="text"
                               value="<?php echo $teacher['surname'] ?>">
                    </div>
                    <div class="form-group">
                        <label>Email:</label>
                        <input class="form-control" name="email" type="email" value="<?php echo $teacher['email'] ?>">
                    </div>
                    <div class="form-group">
                        <label>Level:</label>
                        <input class="form-control" name="level" type="text" value="<?php echo $teacher['level'] ?>">
                    </div>
                    <div>
                        <button type="submit" name="update" class="btn btn-success btn-sm">SAVE</button>
                        <button type="button" onclick="deletePost(<?php echo $teacher['id'] ?>)"
